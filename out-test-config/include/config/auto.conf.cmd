deps_config := \
	...
	drivers/net/wireless/qualcomm/qcacld-3.0/Kconfig \
...
ifneq "$(CC_VERSION_TEXT)" "Android (11889484, +pgo, +bolt, +lto, +mlgo, based on r522817) clang version 18.0.1 (https://android.googlesource.com/toolchain/llvm-project d8003a456d14a3deb8054cdaa529ffbf02d9b262)"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "llvm-nm"
include/config/auto.conf: FORCE
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(HOSTCXX)" "clang++"
include/config/auto.conf: FORCE
